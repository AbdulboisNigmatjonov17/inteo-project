...
export default function Footer() {
    ...
    return (
        <footer className='Container'>
            <hr />
            {/* <div className='my-10 lg:ml-0 ml-5 lg:gap-0 gap-5 w-full flex flex-wrap justify-between'>
                <div data-aos="fade-right" className='w-[590px] '>
                    {/* <h1 className='text-[48px] sm:text-[30px] font-normal leading-[60px] text-[#2C2C2C]'>Kick-start your dream home with us</h1>
                    <h1 className='text-5xl sm:text-2xl font-normal text-[#2C2C2C]'>Kick-start your dream home with us</h1>
